...
const messa = await prepareWAMessageMedia({ image: fs.readFileSync('./media/thumbnail.png') }, { upload: conn.waUploadToServer })
...
"businessOwnerJid": "6285710677726@s.whatsapp.net",
}
